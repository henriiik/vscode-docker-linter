...
var DockerLinterValidator = (function () {
    function DockerLinterValidator(defaults, settingsKey) {
        var _this = this;
        ...
        this.onConfigurationChange = function (settings, requestor) {
            if (settings[_this.settingsKey]) {
                _this.updateSettings(settings[_this.settingsKey]);
            }
